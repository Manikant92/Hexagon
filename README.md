...
## Tech stack and Modules used:
        ...
        React , Flask , Python , NLP ,TensorFlow , OpenCV , Assembly ai ,Agora SDK
...
## Assembly ai and Agora SDK

  Using Assembly ai Sentiment Analysis, can detect the sentiment of each sentence of speech spoken in your audio files and Agora  SDK was helpful while streaming data and doing on device AI computations. 
